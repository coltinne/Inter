...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
        ...
        <asp:RadioButtonList ID="rbl_alternativas0" runat="server" OnSelectedIndexChanged="rbl_alternativas0_SelectedIndexChanged">
        ...
        <asp:Label ID="lbl_text" runat="server" Text="Label"></asp:Label><input type="submit" name="Submit" value="Confirmar" onclick="calculaPerfil(11); return false;"/>
    </form>
</asp:Content>
